...
function getSvg(icon: IconType, alt: string) {
  switch (icon) {
    case 'ADD': 
      return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 491.86 491.86">
        <title>{alt}</title>
